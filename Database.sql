...
DROP TABLE "SYSTEM"."AQ$_KEY_SHARD_MAP" cascade constraints;
...
DROP TABLE "SYSTEM"."LOGMNR_ATTRCOL$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_ATTRIBUTE$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_CCOL$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRC_CONCOL_GG" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRC_CON_GG" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRC_DBNAME_UID_MAP" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_CDEF$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRC_GSBA" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRC_GSII" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRC_GTCS" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRC_GTLO" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRC_INDCOL_GG" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRC_IND_GG" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_COL$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_COLTYPE$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_CON$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_CONTAINER$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRC_SEQ_GG" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRC_SHARD_TS" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRC_TS" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRC_TSPART" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRC_USER" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_DICTIONARY$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_DICTSTATE$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_DID$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_ENC$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_ERROR$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_FILTER$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRGGC_GTCS" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRGGC_GTLO" cascade constraints;
...
DROP TABLE "SYSTEM"."LOGMNR_ICOL$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_IDNSEQ$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_IND$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_INDCOMPART$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_INDPART$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_INDSUBPART$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_KOPM$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_LOB$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_LOBFRAG$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_LOG$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_LOGMNR_BUILDLOG" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_NTAB$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_OBJ$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_OPQTYPE$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_PARAMETER$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_PARTOBJ$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRP_CTAS_PART_MAP" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_PDB_INFO$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_PROCESSED_LOG$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_PROFILE_PLSQL_STATS$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_PROFILE_TABLE_STATS$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_PROPS$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_REFCON$" cascade constraints;
...
DROP TABLE "SYSTEM"."LOGMNR_SEED$" cascade constraints;
...
DROP TABLE "SYSTEM"."LOGMNR_SHARD_TS" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_SPILL$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_SUBCOLTYPE$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_TAB$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_TABCOMPART$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_TABPART$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_TABSUBPART$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNRT_MDDL$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_TS$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_TYPE$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_UID$" cascade constraints;
DROP TABLE "SYSTEM"."LOGMNR_USER$" cascade constraints;
DROP TABLE "SYSTEM"."LOGSTDBY$APPLY_MILESTONE" cascade constraints;
DROP TABLE "SYSTEM"."LOGSTDBY$APPLY_PROGRESS" cascade constraints;
...
DROP TABLE "SYSTEM"."REDO_DB" cascade constraints;
DROP TABLE "SYSTEM"."REDO_LOG" cascade constraints;
DROP TABLE "SYSTEM"."REPL_SUPPORT_MATRIX" cascade constraints;
DROP TABLE "SYSTEM"."REPL_VALID_COMPAT" cascade constraints;
DROP TABLE "SYSTEM"."ROLLING$CONNECTIONS" cascade constraints;
DROP TABLE "SYSTEM"."ROLLING$DATABASES" cascade constraints;
DROP TABLE "SYSTEM"."ROLLING$DIRECTIVES" cascade constraints;
DROP TABLE "SYSTEM"."ROLLING$EVENTS" cascade constraints;
DROP TABLE "SYSTEM"."ROLLING$PARAMETERS" cascade constraints;
DROP TABLE "SYSTEM"."ROLLING$PLAN" cascade constraints;
DROP TABLE "SYSTEM"."ROLLING$STATISTICS" cascade constraints;
DROP TABLE "SYSTEM"."ROLLING$STATUS" cascade constraints;
DROP TABLE "SYSTEM"."SCHEDULER_JOB_ARGS_TBL" cascade constraints;
DROP TABLE "SYSTEM"."SCHEDULER_PROGRAM_ARGS_TBL" cascade constraints;
DROP TABLE "SYSTEM"."SQLPLUS_PRODUCT_PROFILE" cascade constraints;
DROP TABLE "SYSTEM"."TAZA_DE_CAMBIO" cascade constraints;
DROP TABLE "SYSTEM"."TIPO_CONVERSION" cascade constraints;
...
DROP PACKAGE "SYSTEM"."PKG_CONVERTIDOR_MONEDA";
DROP PACKAGE BODY "SYSTEM"."PKG_CONVERTIDOR_MONEDA";
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."TAZA_DE_CAMBIO" 
   (	"FECHA" DATE, 
	"TASA_CAMBIO_DOLLAR" NUMBER(12,4), 
	"TASA_CAMBIO_QUETZALES" NUMBER(12,4)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table TIPO_CONVERSION
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."TIPO_CONVERSION" 
   (	"TIPO_ID" NUMBER(1,0), 
...
SET DEFINE OFF;
Insert into SYSTEM.TAZA_DE_CAMBIO (FECHA,TASA_CAMBIO_DOLLAR,TASA_CAMBIO_QUETZALES) values (to_date('28/05/25','DD/MM/RR'),7.8125,0.128);
Insert into SYSTEM.TAZA_DE_CAMBIO (FECHA,TASA_CAMBIO_DOLLAR,TASA_CAMBIO_QUETZALES) values (to_date('29/05/25','DD/MM/RR'),7.82,0.1279);
Insert into SYSTEM.TAZA_DE_CAMBIO (FECHA,TASA_CAMBIO_DOLLAR,TASA_CAMBIO_QUETZALES) values (to_date('30/05/25','DD/MM/RR'),7.825,0.1278);
Insert into SYSTEM.TAZA_DE_CAMBIO (FECHA,TASA_CAMBIO_DOLLAR,TASA_CAMBIO_QUETZALES) values (to_date('31/05/25','DD/MM/RR'),7.83,0.1277);
Insert into SYSTEM.TAZA_DE_CAMBIO (FECHA,TASA_CAMBIO_DOLLAR,TASA_CAMBIO_QUETZALES) values (to_date('01/06/25','DD/MM/RR'),7.835,0.1276);
Insert into SYSTEM.TAZA_DE_CAMBIO (FECHA,TASA_CAMBIO_DOLLAR,TASA_CAMBIO_QUETZALES) values (to_date('02/06/25','DD/MM/RR'),7.84,0.1276);
commit;
REM INSERTING into SYSTEM.TIPO_CONVERSION
SET DEFINE OFF;
Insert into SYSTEM.TIPO_CONVERSION (TIPO_ID,DESCRIPCION) values (1,'USD a GTQ');
Insert into SYSTEM.TIPO_CONVERSION (TIPO_ID,DESCRIPCION) values (2,'GTQ a USD');
commit;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Package PKG_CONVERTIDOR_MONEDA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE "SYSTEM"."PKG_CONVERTIDOR_MONEDA" AS 
...
/
--------------------------------------------------------
--  DDL for Package Body PKG_CONVERTIDOR_MONEDA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "SYSTEM"."PKG_CONVERTIDOR_MONEDA" AS
  ...
  BEGIN
    ...
    ELSE
      -- tipo inválido: devolvemos cero o podrías lanzar una excepción
      p_conversion := 0;
    END IF;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX"  ENABLE;
--------------------------------------------------------
--  Constraints for Table TAZA_DE_CAMBIO
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TAZA_DE_CAMBIO" MODIFY ("TASA_CAMBIO_DOLLAR" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TAZA_DE_CAMBIO" MODIFY ("TASA_CAMBIO_QUETZALES" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TAZA_DE_CAMBIO" ADD PRIMARY KEY ("FECHA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX"  ENABLE;
--------------------------------------------------------
--  Constraints for Table TIPO_CONVERSION
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."TIPO_CONVERSION" MODIFY ("DESCRIPCION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TIPO_CONVERSION" ADD PRIMARY KEY ("TIPO_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
